...
import com.webul.base.dao.CommonDao;
import com.webul.bean.MailList;
import com.webul.bean.MailListGroup;
import com.webul.bean.SendSmsRecord;
import com.webul.bean.SmsPlatformSet;
import com.webul.util.sms.ClientSDK;
import com.webul.util.user.SystemUtils;
...
public class SmsPlatformService {
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Throwable.class)
	public Map<String,String> sendsms(String phone,String txt,String type,
		...
		if(!list.isEmpty()){
			...
			if(isa>=0){
				...
				for(int i=0;i<a.length;i++){
					...
					sms_return=sdk.sendSms(sms_name, sms_pwd, a[i].toString(), "【"+list.get(0).getSign()+"】"+txt);//调用短信平台发送接口
